"""CMS Care Compare — hospital/provider quality ratings via DKAN SQL API."""
...
class Adapter(CMSBaseAdapter):
    # data.cms.gov provider-data dataset for Hospital General Information
    DATASET_SQL_TABLE = "xubh-q36u"

    @property
    def source_name(self) -> str:
        return "cms_care_compare"
