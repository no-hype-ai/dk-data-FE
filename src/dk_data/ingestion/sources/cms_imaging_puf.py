"""CMS Imaging Services PUF loader. Loads to hcs_raw.cms_imaging_puf."""
...
from ..utils.validators import CMSImagingRecord
...
def load_cms_imaging_puf(filepath: Optional[str] = None, rows: Optional[List[Dict]] = None, source_year: int = 2023, max_records: int = 0, source_hash: Optional[str] = None) -> dict:
    """Load CMS Imaging Services PUF data from CSV file."""
    logger.info(f"Loading CMS Imaging PUF (year={source_year})")
