...
Loads normalized USPTO patent records into raw.uspto_ci with upsert
semantics (ON CONFLICT DO UPDATE on patent_id).

Target table: raw.uspto_ci (see migration 060_ci_source_tables.sql)
"""
...
def load_uspto_ci_data(
    ...
    """Load USPTO CI patent records into raw.uspto_ci.
    ...
    logger.info("Loading %d USPTO CI records into raw.uspto_ci", len(records))
