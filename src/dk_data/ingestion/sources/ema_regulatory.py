...
Loads EMA regulatory records into mol_raw.ema_regulatory.
...
def load_ema_regulatory_data(
    ...
    """Load EMA regulatory records into mol_raw.ema_regulatory. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('document_id', f'ema_regulatory_{idx}')
