...
TABLE = 'hcs_raw.cms_part_d_spending'
API_ENDPOINT = 'cms_part_d_spending'
...
def load_cms_part_d_spending_data(
    ...
    """Load CMS Part D spending records into hcs_raw.cms_part_d_spending as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = str(raw_record.get('brand_name', f'{SOURCE_NAME}_{idx}'))
