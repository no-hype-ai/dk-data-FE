...
Loads OpenAlex work records into mol_raw.openalex_ci.
...
TABLE = 'mol_raw.openalex_ci'
API_ENDPOINT = 'openalex'
...
def load_openalex_ci_data(
    ...
    """Load OpenAlex CI records into mol_raw.openalex_ci. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('work_id', f'openalex_ci_{idx}')
