...
TABLE = 'hcs_raw.cms_nucc'
API_ENDPOINT = 'cms_nucc'
...
def load_cms_nucc_data(
    ...
    """Load CMS NUCC records into hcs_raw.cms_nucc as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = str(raw_record.get('taxonomy_code', f'{SOURCE_NAME}_{idx}'))
