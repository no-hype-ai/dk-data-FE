"""Source loader for CMS Hospital Readmissions Reduction Program data."""
import hashlib
import json
import logging
...
TABLE = 'hcs_raw.cms_hrrp'
API_ENDPOINT = 'cms_hrrp'


def load_cms_hrrp_data(
    records: List[Dict[str, Any]],
    source_hash: Optional[str] = None,
    source_file: Optional[str] = None,
    batch_size: int = 500,
) -> Dict[str, Any]:
    """Load CMS HRRP records into hcs_raw.cms_hrrp as JSONB."""
    if not records:
