...
def load_cms_mental_health_puf(filepath: str, source_year: int = 2023, max_records: int = 0) -> dict:
    """Load CMS Mental Health PUF data from CSV file."""
    logger.info(f"Loading CMS Mental Health PUF from {filepath} (year={source_year})")
