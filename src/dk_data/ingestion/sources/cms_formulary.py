...
TABLE = 'hcs_raw.cms_formulary'
API_ENDPOINT = 'cms_formulary'
...
def load_cms_formulary_data(
    ...
    """Load CMS Formulary records into hcs_raw.cms_formulary as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = str(raw_record.get('formulary_id', f'{SOURCE_NAME}_{idx}'))
