...
Loads EUIPO registered community design records into raw.euipo_designs
with upsert semantics (ON CONFLICT DO UPDATE on application_number).

Target table: raw.euipo_designs
"""
...
def load_euipo_designs_data(
    ...
    """Load EUIPO design records into raw.euipo_designs.
    ...
    logger.info("Loading %d EUIPO design records into raw.euipo_designs", len(records))
