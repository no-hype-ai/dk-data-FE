...
def load_cms_inpatient_puf(filepath: Optional[str] = None, rows: Optional[List[Dict]] = None, source_year: int = 2023, max_records: int = 0, source_hash: Optional[str] = None) -> dict:
    """Load CMS Inpatient PUF charge data from CSV file."""
    logger.info(f"Loading CMS Inpatient PUF (year={source_year})")
