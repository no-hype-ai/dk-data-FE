...
Loads medical news article records into mol_raw.medical_news.
...
TABLE = 'mol_raw.medical_news'
API_ENDPOINT = 'medical_news'
...
def load_medical_news_data(
    ...
    """Load medical news records into mol_raw.medical_news. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('article_id', f'medical_news_{idx}')
