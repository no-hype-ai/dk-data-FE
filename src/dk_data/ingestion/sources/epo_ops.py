...
Loads EPO patent records into mol_raw.epo_patents.
...
SOURCE_NAME = 'epo_ops'
TABLE = 'mol_raw.epo_patents'
API_ENDPOINT = 'epo_ops'
...
def load_epo_ops_data(
    ...
    """Load EPO patent records into mol_raw.epo_patents. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('publication_id', f'epo_ops_{idx}')
