...
TABLE = 'hcs_raw.cms_open_payments'
API_ENDPOINT = 'cms_open_payments'
...
def load_cms_open_payments_data(
    ...
    """Load CMS Open Payments records into hcs_raw.cms_open_payments as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = str(raw_record.get('record_id', f'{SOURCE_NAME}_{idx}'))
