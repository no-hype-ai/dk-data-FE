...
TABLE = 'hcs_raw.cms_magnet'
API_ENDPOINT = 'cms_magnet'
...
def load_cms_magnet_data(
    ...
    """Load CMS Magnet records into hcs_raw.cms_magnet as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = str(raw_record.get('facility_name', f'{SOURCE_NAME}_{idx}'))
