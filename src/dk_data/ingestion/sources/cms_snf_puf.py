...
def load_cms_snf_puf(filepath: Optional[str] = None, rows: Optional[List[Dict]] = None, source_year: int = 2023, max_records: int = 0, source_hash: Optional[str] = None) -> dict:
    """Load CMS SNF PUF data from CSV file."""
    logger.info(f"Loading CMS SNF PUF (year={source_year})")
