...
TABLE = 'hcs_raw.cms_chronic_conditions'
API_ENDPOINT = 'cms_chronic_conditions'
...
def load_cms_chronic_conditions_data(
    ...
    """Load CMS Chronic Conditions records into hcs_raw.cms_chronic_conditions as JSONB."""
    if not records:
