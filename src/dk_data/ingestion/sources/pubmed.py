...
mol_raw.pubmed. Stores full raw response as JSONB.
"""
...
SOURCE_NAME = 'pubmed'
TABLE = 'mol_raw.pubmed'
API_ENDPOINT = 'ncbi_efetch'
...
def load_pubmed_data(
    ...
    """Load PubMed article records into mol_raw.pubmed. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('pmid', f'pubmed_{idx}')
