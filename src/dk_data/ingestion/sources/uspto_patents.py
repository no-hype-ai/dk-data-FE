...
Loads USPTO patent records into mol_raw.uspto_patents.
...
def load_uspto_patents_data(
    ...
    """Load USPTO patent records into mol_raw.uspto_patents. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('patent_number', f'uspto_patents_{idx}')
