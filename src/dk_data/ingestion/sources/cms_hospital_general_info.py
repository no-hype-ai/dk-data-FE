...
TABLE = 'hcs_raw.cms_hospital_general_info'
API_ENDPOINT = 'cms_hospital_general_info'
...
def load_cms_hospital_general_info_data(
    ...
    """Load CMS Hospital General Info records into hcs_raw.cms_hospital_general_info as JSONB."""
    if not records:
