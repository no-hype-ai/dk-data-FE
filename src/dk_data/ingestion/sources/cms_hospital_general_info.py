...
COLUMN_MAPPING = {
    ...
    'Meets criteria for birthing friendly designation': 'meets_criteria_for_birthing_friendly_designation',
    'Hospital overall rating': 'hospital_overall_rating',
    'Hospital overall rating footnote': 'hospital_overall_rating_footnote',
    # alternate casing / passthrough variants
...
def load_cms_hospital_general_info(filepath: str, source_year: int = 2023, max_records: int = 0) -> dict:
    ...
    for idx, row in df.iterrows():
        try:
            rec = CMSHospitalGeneralInfoRecord(
                ...
                county_parish=row.get('county_parish'),
                ...
                meets_criteria_for_birthing_friendly_designation=row.get('meets_criteria_for_birthing_friendly_designation'),
