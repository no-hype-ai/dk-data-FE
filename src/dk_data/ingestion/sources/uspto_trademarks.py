...
def load_uspto_trademarks_data(
    ...
    """Load USPTO trademark records into raw.uspto_trademarks.
    ...
    logger.info("Loading %d USPTO trademark records into raw.uspto_trademarks", len(records))
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    cur.execute(
                        """
                        INSERT INTO raw.uspto_trademarks (
