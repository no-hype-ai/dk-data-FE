...
Loads USPTO TSDR trademark records into mol_raw.uspto_trademarks.
...
TABLE = 'mol_raw.uspto_trademarks'
API_ENDPOINT = 'uspto_tsdr'
...
def load_uspto_trademarks_data(
    ...
    """Load USPTO trademark records into mol_raw.uspto_trademarks. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('serial_number', f'uspto_trademarks_{idx}')
