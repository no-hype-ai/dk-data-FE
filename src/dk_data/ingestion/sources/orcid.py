...
Loads ORCID researcher profiles into mol_raw.orcid.
...
def load_orcid_data(
    ...
    """Load ORCID researcher profiles into mol_raw.orcid. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('orcid_id', f'orcid_{idx}')
