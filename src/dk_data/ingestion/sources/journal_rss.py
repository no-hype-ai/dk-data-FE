...
Loads journal RSS article records into mol_raw.journal_rss.
...
TABLE = 'mol_raw.journal_rss'
API_ENDPOINT = 'journal_rss'
...
def load_journal_rss_data(
    ...
    """Load journal RSS article records into mol_raw.journal_rss. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('article_id', f'journal_rss_{idx}')
