...
TABLE = 'hcs_raw.cms_part_b_spending'
API_ENDPOINT = 'cms_part_b_spending'
...
def load_cms_part_b_spending_data(
    ...
    """Load CMS Part B spending records into hcs_raw.cms_part_b_spending as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = str(raw_record.get('hcpcs_code', f'{SOURCE_NAME}_{idx}'))
