"""CMS Telehealth Trends PUF loader. Loads to hcs_raw.cms_telehealth_puf."""
...
def load_cms_telehealth_puf(filepath: str, source_year: int = 2023) -> dict:
    """Load CMS Telehealth Trends PUF data from CSV file."""
