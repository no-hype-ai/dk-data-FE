...
def load_cms_telehealth_puf(filepath: Optional[str] = None, rows: Optional[List[Dict]] = None, source_year: int = 2023, max_records: int = 0, source_hash: Optional[str] = None) -> dict:
    """Load CMS Telehealth Utilization PUF data from CSV file."""
    logger.info(f"Loading CMS Telehealth PUF (year={source_year})")
