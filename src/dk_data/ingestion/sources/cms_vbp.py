"""Source loader for CMS Hospital Value-Based Purchasing data."""
import hashlib
import json
import logging
...
SOURCE_NAME = 'cms_vbp'
TABLE = 'hcs_raw.cms_vbp'
API_ENDPOINT = 'cms_vbp'


def load_cms_vbp_data(
    records: List[Dict[str, Any]],
    source_hash: Optional[str] = None,
    source_file: Optional[str] = None,
    batch_size: int = 500,
) -> Dict[str, Any]:
    """Load CMS VBP records into hcs_raw.cms_vbp as JSONB."""
    if not records:
