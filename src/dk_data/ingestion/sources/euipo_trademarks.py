...
Loads EUIPO trademark records into mol_raw.euipo_trademarks.
...
TABLE = 'mol_raw.euipo_trademarks'
API_ENDPOINT = 'euipo'
...
def load_euipo_trademarks_data(
    ...
    """Load EUIPO trademark records into mol_raw.euipo_trademarks. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('application_number', f'euipo_{idx}')
