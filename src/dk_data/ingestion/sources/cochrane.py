...
Loads Cochrane review records into mol_raw.cochrane_reviews.
...
TABLE = 'mol_raw.cochrane_reviews'
API_ENDPOINT = 'cochrane'
...
def load_cochrane_data(
    ...
    """Load Cochrane review records into mol_raw.cochrane_reviews. Stores full raw response as JSONB."""
    if not records:
        ...
        with conn.cursor() as cur:
            for idx, raw_record in enumerate(records):
                try:
                    ...
                    request_id = raw_record.get('review_id', f'cochrane_{idx}')
