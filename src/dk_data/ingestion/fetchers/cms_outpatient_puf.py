"""CMS Hospital Outpatient PUF fetcher stub. File is downloaded by CronJob."""
import logging
...
class CMSOutpatientPUFFetcher(BaseFetcher):
    ...
    def fetch(self, **kwargs) -> Dict[str, Any]:
        ...
        logger.info("cms_outpatient_puf: file-based source; use --file flag with ingestion.main")
