"""CMS Medicare Inpatient PUF fetcher stub. File is downloaded by CronJob."""
import logging
...
class CMSInpatientPUFFetcher(BaseFetcher):
    ...
    def fetch(self, **kwargs) -> Dict[str, Any]:
        ...
        logger.info("cms_inpatient_puf: file-based source; use --file flag with ingestion.main")
