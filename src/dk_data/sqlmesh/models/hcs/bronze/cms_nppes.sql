...
SELECT
    ...
    NULL::TEXT AS provider_middle_name,
    NULL::TEXT AS provider_name_prefix_text,
    NULL::TEXT AS provider_name_suffix_text,
    ...
    NULL::TEXT AS provider_business_mailing_address_fax_number,
    NULL::TEXT AS provider_business_mailing_address_country_code,
