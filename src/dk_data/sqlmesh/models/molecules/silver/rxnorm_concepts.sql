...
-- Promotes mol_bronze.rxnorm into silver.identifier_mappings (rxcui entries)
...
--
-- Entity linking: name match → silver.molecules, then alias fallback.
...
SELECT
    ...
    -- Molecule linkage: name → silver.molecules, fallback to alias table
