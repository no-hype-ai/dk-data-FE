-- SQLMesh Model: Bronze FDA Warning Letters
-- Passthrough from mol_raw.fda_warning_letters to typed bronze layer.
-- Feature: 006-claims-engine-data-gaps (T074)

MODEL (
    name mol_bronze.fda_warning_letters,
