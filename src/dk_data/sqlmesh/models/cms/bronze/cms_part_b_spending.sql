-- SQLMesh Model: Bronze CMS Part B Spending by Drug
-- Normalizes raw Part B Drug Spending Dashboard to typed Bronze columns
-- Part of: 016-cms-puf-datasource-integration

MODEL (
    name bronze.cms_part_b_spending,
    kind INCREMENTAL_BY_TIME_RANGE (
        time_column _loaded_at,
        batch_size 500
    ),
    cron '@daily',
    audits (not_null(columns := (hcpcs_code, year))),
    grain (hcpcs_code, year)
);
