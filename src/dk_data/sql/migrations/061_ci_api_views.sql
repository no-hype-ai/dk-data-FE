-- Migration: 061_ci_api_views
-- Feature: 011-datasource-integration
-- Purpose: Create API views exposing Tier 4 CI source data via PostgREST
-- Run: psql -h localhost -p 5433 -U postgres -d dk_data -f migrations/061_ci_api_views.sql
...
DO $$
BEGIN
    RAISE NOTICE 'CI API views migration complete (061_ci_api_views.sql)';
    RAISE NOTICE 'Views created: pubmed_publications, openalex_publications,';
    ...
    RAISE NOTICE 'All 10 views granted SELECT to web_anon and analyst roles';
END
$$;
