...
-- =============================================================================
-- 1. hcs_raw.cms_open_payments — loader targets this, but 083 created 3 split tables
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_cms_open_payments_npi ON hcs_raw.cms_open_payments (covered_recipient_npi);

-- =============================================================================
-- 2. hcs_raw.cms_part_d_prescriber — loader uses drug_brand_name, prescriber_* columns
...
-- =============================================================================
-- 3. hcs_raw.cms_hospital_general_info — drop PK so loader can use facility_id
-- =============================================================================
ALTER TABLE hcs_raw.cms_hospital_general_info DROP CONSTRAINT IF EXISTS cms_hospital_general_info_pkey;
ALTER TABLE hcs_raw.cms_hospital_general_info ALTER COLUMN provider_id DROP NOT NULL;

-- =============================================================================
-- 4. hcs_raw.cms_hospital_quality — drop PK so loader can use facility_id
-- =============================================================================
ALTER TABLE hcs_raw.cms_hospital_quality DROP CONSTRAINT IF EXISTS cms_hospital_quality_pkey;
ALTER TABLE hcs_raw.cms_hospital_quality ALTER COLUMN provider_id DROP NOT NULL;
ALTER TABLE hcs_raw.cms_hospital_quality ALTER COLUMN measure_id DROP NOT NULL;

-- =============================================================================
-- 5. hcs_raw.cms_ndc — drop PK on ndc, loader uses product_ndc via UNIQUE constraint
-- =============================================================================
ALTER TABLE hcs_raw.cms_ndc DROP CONSTRAINT IF EXISTS cms_ndc_pkey;
