...
CREATE TABLE mol_bronze.pubchem_y2024m06
    PARTITION OF mol_bronze.pubchem
    FOR VALUES FROM ('2024-06-01') TO ('2024-07-01');

CREATE TABLE mol_bronze.pubchem_y2025m01
    PARTITION OF mol_bronze.pubchem
    FOR VALUES FROM ('2025-01-01') TO ('2025-02-01');

CREATE TABLE mol_bronze.pubchem_y2025m06
    PARTITION OF mol_bronze.pubchem
    FOR VALUES FROM ('2025-06-01') TO ('2025-07-01');

CREATE TABLE mol_bronze.pubchem_y2026m01
    PARTITION OF mol_bronze.pubchem
