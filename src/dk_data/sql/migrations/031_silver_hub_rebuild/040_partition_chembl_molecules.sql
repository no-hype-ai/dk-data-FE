-- Migration 031/040_partition_chembl_molecules.sql: Partition mol_bronze.chembl_molecules by month on ingested_at
...
CREATE TABLE mol_bronze.chembl_molecules_y2024m01
    PARTITION OF mol_bronze.chembl_molecules
    FOR VALUES FROM ('2024-01-01') TO ('2024-02-01');

CREATE TABLE mol_bronze.chembl_molecules_y2024m06
    PARTITION OF mol_bronze.chembl_molecules
    FOR VALUES FROM ('2024-06-01') TO ('2024-07-01');

CREATE TABLE mol_bronze.chembl_molecules_y2025m01
    PARTITION OF mol_bronze.chembl_molecules
    FOR VALUES FROM ('2025-01-01') TO ('2025-02-01');

CREATE TABLE mol_bronze.chembl_molecules_y2025m06
    PARTITION OF mol_bronze.chembl_molecules
    FOR VALUES FROM ('2025-06-01') TO ('2025-07-01');

CREATE TABLE mol_bronze.chembl_molecules_y2026m01
    PARTITION OF mol_bronze.chembl_molecules
    FOR VALUES FROM ('2026-01-01') TO ('2026-02-01');

-- Default partition catches everything outside the above ranges
CREATE TABLE mol_bronze.chembl_molecules_default
    PARTITION OF mol_bronze.chembl_molecules DEFAULT;
...
-- CREATE INDEX ON mol_bronze.chembl_molecules_y2026m01 USING BRIN (ingested_at);
