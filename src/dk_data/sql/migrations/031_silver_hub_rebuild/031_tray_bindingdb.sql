-- Migration 031/031_tray_bindingdb.sql: Tray procedure for mol_bronze.bindingdb
-- Feature: 001-silver-medallion-rebuild / T151-T154
--
-- Atomically rebuilds mol_bronze.bindingdb via unlogged tray table.
...
DECLARE
    ...
    v_tray_name     CONSTANT TEXT    := 'bindingdb_tray';
    v_target_name   CONSTANT TEXT    := 'bindingdb';
    v_old_name      CONSTANT TEXT    := 'bindingdb_old';
...
BEGIN
    ...
    LOOP
        ...
        EXECUTE format(
            'INSERT INTO %I.%I SELECT * FROM %I.%I ORDER BY entry_id LIMIT %L OFFSET %L',
        ...
        INSERT INTO meta.transform_runs (
            ...
            'mol_bronze.refresh_bindingdb_via_tray', v_chunk_pos, v_chunk_rows, v_wal_bytes, NOW()
    ...
    RAISE NOTICE 'refresh_bindingdb_via_tray complete: % rows inserted', v_rows_inserted;
END;
$$;
