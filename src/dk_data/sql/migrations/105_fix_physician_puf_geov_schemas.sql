...
CREATE TABLE IF NOT EXISTS raw.cms_physician_puf_default
    PARTITION OF raw.cms_physician_puf DEFAULT;
...
ALTER TABLE raw.cms_geographic_variation ADD PRIMARY KEY (state, year);
