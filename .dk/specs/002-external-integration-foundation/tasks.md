...
- [x] T072 [US4] Write `tests/test_216_missing_mol_api_views.py` — verify `mol_api.competitive_scores` exists, grant is present, and the score formula produces expected values for known gold-layer rows — `tests/test_216_missing_mol_api_views.py` (US-14)
...
- [x] T074 [US5] Write `tests/test_217_resolve_function_grants.py` — verify every resolve function is callable by analyst + api_user — `tests/test_217_resolve_function_grants.py` (US-14)
